...
const categories = [
  ...
  { title: "Programming", description: "Discuss programming languages, frameworks, and best practices." },
  { title: "Hardware", description: "Share and seek advice on computer hardware." },
